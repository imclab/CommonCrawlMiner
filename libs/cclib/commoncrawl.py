...
class CommonCrawl(object):
    ...
    crawl_prefix = {
        ...
        '2014_2':'common-crawl/crawl-data/CC-MAIN-2014-15/segments',
        '2014_3':'common-crawl/crawl-data/CC-MAIN-2014-23/segments/',
        '2014_4':'common-crawl/crawl-data/CC-MAIN-2014-35/segments/'
    }
    crawl_id_list = ['2013_1','2013_2','2014_1','2014_2','2014_3','2014_4',"ALL"]
